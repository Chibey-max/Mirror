...
| --- | --- | --- | --- |
| Deployer | `DEPLOYER_PRIVATE_KEY` | None after construction | Deploys contracts only. Fund for deployment gas; do not use it to register agents, administer PolicyModule or run fills. |
